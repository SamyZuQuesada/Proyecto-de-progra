...
public:
    ...
    void setRegistrarMedico() {
        ...
        for (size_t i = 0; i < listaMedicos.size(); i++) {
        ...
        } while (nombre.empty() || (telefono <= 0) || correo.empty());
        ...
        if (cedula < 0 || cedula > 2222222222) {
            ...
            for (size_t i = 0; i < listaMedicos.size(); i++) {
                if (listaMedicos[i]->getCedula() == cedula) {
                    ...
                    cout << "Ingrese el nuevo telefono del medico: ";
                    cin >> nuevoTelefono;
                    cin.ignore();
                    ...
                    cout << "Ingrese la nueva disponibilidad del medico (1 si esta disponible, 0 si no esta disponible): ";
